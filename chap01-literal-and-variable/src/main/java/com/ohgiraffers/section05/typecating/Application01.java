...
public class Application01 {
    ...
    public static void main(String[] args) {
       ...
       // int a = 9L +10;  (x)
        ...
        long result1 = num1 + num2; // int+long 은 서로 다른 자료형이라 데이터 손실이 발생하지 않는 int-> long 변환을 자동 수행 후 연산한다.
         */

        long result1 = num1 + num2;
        System.out.println("result1 :" +result1);    //정상수행됨
        ...
        * 바이트 크기 보다 훨씬 더 많은 값을 표현할 수 있다.
        ...
        /* 설명 int 로 type 이 정해지지 않은 리터럴 형태의 정수는 char 형 변수에 기록 가능하다 */
        char ch2 = 65;
