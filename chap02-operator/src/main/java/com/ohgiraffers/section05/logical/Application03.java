...
public class Application03 {
     ...
     * */
        ...
        /*
        * 조건식 두 개가 모두 만족해야  true 를 반환하지만 앞에서 미리 false가 나오게 되면
        * 뒤에 조건을 확인할 필요없이 false 를 반환한다.
        ...
        * */
        ...
        /*
        * 논리식 || 논리식 : 앞에 결과가 true 이면 뒤를 실행하지 않음
        * 조건식 둘 중 하나라도 true 를 반환하면 true를 반환하기 때문에 앞에서 미리 true 가 나오게 되면
        * 뒤에 조건을 확인 할 필요 없이 true 를 반환한다.
        * 따라서 연산 횟수를 줄이기 위해서는 ||연산자의 경우 앞에 true 가 나오르 가능성이 놓은 조건을 작성하는 편이 좋다.
        * */
